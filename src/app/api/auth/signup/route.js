...
export async function POST(req) {
  try {
    ...
    if (autoCheckPassed) {
      message =
        "လက်မှတ် အတည်ပြုခြင်း အောင်မြင်ပါသည်! သင့်ခိုလှုံရာအိမ် မှတ်ပုံတင်ခြင်းကို စီမံခန့်ခွဲသူ အတည်ပြုရန် စောင့်ဆိုင်းနေပါသည်။";
    } else if (verificationStatus === "auto_rejected") {
      message =
        "တင်သွင်းထားသော ပုံကို တရားဝင်လက်မှတ်အဖြစ် အတည်ပြုနိုင်ခြင်း မရှိပါ။ ကျေးဇူးပြု၍ သင့်ခိုလှုံရာအိမ် လိုင်စင်/လက်မှတ်၏ ရှင်းလင်းသော ဓာတ်ပုံကို တင်ပေးပါ။";
    } else {
      message =
